...
void main() {
  ...
  group('get Now Playing Movies', () {
    ...
    test('should return list of Movie Model when the response code is 200',
      ...
      when(mockHttpClient
          ...
          .thenAnswer((_) async =>
              http.Response(readJson('dummy_data/now_playing.json'), 200,headers: {
  ...
  group('get movie detail', () {
    ...
    test('should return movie_search detail when the response code is 200',
        () async {
      // arrange
      when(mockHttpClient
  ...
  group('get movie recommendations', () {
    ...
    test('should return list of Movie Model when the response code is 200',
      ...
      when(mockHttpClient.get(Uri.parse(
              '$BASE_URL/movie/$tId/recommendations?$API_KEY')))
